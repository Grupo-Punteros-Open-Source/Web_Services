...
public class UpdateAdvertisingCommandFromResourceAssembler {
    public static UpdateAdvertisingCommand toCommandFromResource(Long id, UpdateAdvertisingResource resource) {
        return new UpdateAdvertisingCommand(id, resource.comName(), resource.comImage(), resource.workshop_id(), resource.imageUrl(), resource.slogan(), resource.priceMsg(), resource.disMsg(), resource.repairMsg());
    }
}
