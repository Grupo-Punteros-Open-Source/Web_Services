...
public class AdvertisingResourceFromEntityAssembler {
    public static AdvertisingResource toResourceFromEntity(Advertising entity) {
        return new AdvertisingResource(entity.getId(), entity.getComName(), entity.getComImage(), entity.getWorkshopId().getId(), entity.getImageUrl(), entity.getSlogan(), entity.getPriceMsg(), entity.getDisMsg(), entity.getRepairMsg());
    }
}
